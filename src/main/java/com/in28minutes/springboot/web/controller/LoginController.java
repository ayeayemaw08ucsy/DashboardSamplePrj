...
public class LoginController {
	...
	@RequestMapping(value = "/dashboardmodel", method = RequestMethod.GET)
	public ModelAndView filling() throws Exception {
        ...
        Gson  gson = new Gson();
        ModelAndView model = new ModelAndView("dashboardmodel");
        model.addObject("corechart", gson.toJson(result));
	    return model;    
	    // model.put("results", result);
	        
	    //    return new ModelAndView("welcome", (Map) model);
	}     
}
